RM 2D Logic Pro v1.4.5C — Name-specific Image / Text / CSV Share
...
Upload every file and the vendor folder together to the GitHub Pages repository root. Do not rename files. After deployment, refresh once so the v1.4.5C service worker replaces older cached versions.
